...
class DefaultPluginRepositoryHandler extends DefaultNamedDomainObjectList<PluginRepositoryInternal> {
    ...
    DefaultPluginRepositoryHandler(FileResolver fileResolver, Factory<DependencyResolutionServices> dependencyResolutionServicesFactory, VersionSelectorScheme versionSelectorScheme, Instantiator instantiator) {
        super(PluginRepositoryInternal.class, instantiator, new RepositoryNamer());
        this.fileResolver = fileResolver;
        this.dependencyResolutionServicesFactory = dependencyResolutionServicesFactory;
        this.versionSelectorScheme = versionSelectorScheme;
    }

    private static class RepositoryNamer implements Namer<PluginRepositoryInternal> {
        @Override
        public String determineName(PluginRepositoryInternal repository) {
            return repository.getName();
        }
    }

    public DefaultMavenPluginRepository maven(Action<? super DefaultMavenPluginRepository> configurationAction) {
